...
Follow the plan in `implementation_plan.md`. The active working plan is also tracked at `~/.claude/plans/optimized-petting-lovelace.md`.

## Workflow Instructions

- **Update the plan**: After completing each step, mark it as done in `implementation_plan.md`.
